  ...
  return (
    ...
    <div className='py-16'>
      ...
      <div className='text-center mb-10 px-6 lg:px-16'>
        ...
        <p className='text-base lg:text-lg font-poppins mb-4'>As your logistics partner, we will take the time to understand your requirements, pain points and goals, allowing us to deliver a tailored solution that relieves the hassle of logistics and allows you to focus on the things that matter most to your business. </p>
        <p className='text-base lg:text-lg font-poppins'>You’ll enjoy an efficient, professional service, along with door-to-door solutions to any location worldwide.
